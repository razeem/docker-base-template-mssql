...
if (!empty($_ENV['DRUPAL_TRUSTED_HOST_PATTERNS'])) {
  ...
  foreach ($expode_trusted_host_pattern as $key => $url) {
    ...
    if (isset($parsed_url)) {
      // Create a trusted host pattern from the host.
      $host = str_replace('.', '\.', $parsed_url);
      // Create the regex pattern.
      $trusted_host_pattern[] = '^' . $host . '$';
    }
  }
...
$settings['file_assets_path'] = 'sites/default/dist/assets';
$settings['php_storage']['twig'] = [
  'directory' => 'sites/default/dist/php',
];
